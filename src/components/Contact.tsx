      ...
      <div className="container mx-auto flex justify-center px-4 md:px-6">
        <div className="w-full max-w-xl space-y-8">
          ...
          <div className="space-y-6">
            ...
            {/* Change the text inside this span */}
            <span className="font-medium">Makati City, Metro Manila, Philippines</span>
            </div>
            <div className="flex items-center justify-center gap-4">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <Link href="https://drive.google.com/file/d/1UOhTEXHIadubLKWIU63_-k1s_v3GZ7Og/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="font-medium hover:underline">
                Meshary's CV
              </Link>
            </div>
          </div>
