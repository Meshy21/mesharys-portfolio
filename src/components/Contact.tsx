        ...
        <div className="w-full max-w-xl space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <Link href="https://drive.google.com/file/d/1zgdQHeFZdbjkyfwAABfBjPgmxIqlUWqo/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="font-medium hover:underline">
                Meshary's CV
              </Link>
            </div>
          </div>
